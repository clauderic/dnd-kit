import {Preview, Info, Solid} from '@/components-docs';
import {Example as Hero} from './Draggable.stories';

{/* Examples */}
import {Example} from './examples/Example';
import {ExampleWithHandle} from './examples/ExampleWithHandle';
import {ExampleWithModifier} from './examples/ExampleWithModifier';

{/* Source code text */}
import ExampleSource from './examples/Example?raw';
import ExampleWithHandleSource from './examples/ExampleWithHandle?raw';
import ExampleWithModifierSource from './examples/ExampleWithModifier?raw';

import DraggableSource from './examples/Draggable?raw';
import DraggableWithHandleSource from './examples/DraggableWithHandle?raw';
...
To get started, we will create two files, `App.jsx` and `Draggable.jsx`.

<Preview
  tabs={['Example.jsx', 'Draggable.jsx']}
...
<Preview
  tabs={['DraggableWithHandle.jsx']}
  code={[DraggableWithHandleSource]}
>
  <Solid of={ExampleWithHandle} />
</Preview>

Alternatively, you can also pass an `Element` as an argument to the `handle` option of `useDraggable`:
...
<Preview
  code={[ExampleWithModifierSource]}
>
  <Solid of={ExampleWithModifier} />
</Preview>
