import {Preview, Solid} from '@/components-docs';
...
To get started, we will create three files, `App.jsx`, `Droppable.jsx`, and `Draggable.jsx`.

<Preview
  code={[ExampleSource, DroppableSource, DraggableSource]}
  tabs={['App.jsx', 'Droppable.jsx', 'Draggable.jsx']}
>
  <Solid of={Example} />
</Preview>
...
<Preview code={[MultipleDroppableExampleSource]} tabs={['App.jsx']}>
  <Solid of={MultipleDroppableExample} />
</Preview>
