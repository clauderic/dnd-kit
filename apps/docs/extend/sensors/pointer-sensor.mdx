...
<ParamField path="Delay" type="class">
  ...
  **Options:**
  ...
  - `tolerance` (Distance): Maximum movement allowed during delay. Can be a number, Coordinates object, or axis-specific coordinates. Exceeding this aborts activation.
</ParamField>
