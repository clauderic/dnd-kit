...
<ParamField path="Distance" type="class">
  ...
  **Options:**
  - `value` (number): Required distance in pixels.
  - `tolerance` (Distance, optional): If specified, aborts activation if movement exceeds this threshold. Can be a number, Coordinates object, or axis-specific coordinates.
</ParamField>
