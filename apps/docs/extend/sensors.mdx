  ...
  sensors: [
    PointerSensor.configure({
      ...
      activationConstraints: [
        new PointerActivationConstraints.Distance({value: 5}), // Start after moving 5px
        new PointerActivationConstraints.Delay({value: 200, tolerance: 10}),  // Or after holding for 200ms
      ]
    }),
    KeyboardSensor,
  ]
