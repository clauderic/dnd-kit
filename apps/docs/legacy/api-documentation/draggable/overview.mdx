...
title: Draggable
description: >-
  Use the `useDraggable` hook turn DOM nodes into draggable sources that can be picked up, moved and dropped over [droppable](../droppable/overview) containers.
...
<Card href="./drag-overlay" horizontal icon="send-backward" iconType="light">
  Drag overlay
</Card>
