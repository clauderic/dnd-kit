...
Collision observation coalesces geometry and input changes, retains pending results through rendering and public suspension, and reconciles the latest accepted input before drop. DOM measurements refresh after placement commits and scroll events, project newly started ancestor animations without a cached animation list, and strict descendants of the dragged subtree are excluded from collision candidates.
