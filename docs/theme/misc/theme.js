...
import {useActiveAnchorSet} from '../components';
          ...
          {tokens.map((line, i) => (
            ...
            >
              ...
              {line.map((token, key) => {
                ...
                const {className, ...props} = getTokenProps({token, key});
                  ...
                  <span
                    ...
                    className={classNames(
                      ...
                      types.includes('keyword') &&
                        ['const', 'function', 'null', 'undefined'].includes(
                          content
                        ) &&
                        content
                    )}
...
export default ({children}) => {
  ...
  return (
    <MDXProvider components={getComponents({slugger})}>{children}</MDXProvider>
  );
};
