...
<table>
  ...
  <tr>
    ...
    <td>
      <p>
        The ARIA <code>&quot;role&quot;</code> attribute lets you explicitly
        define the role for an element, which communicates its purpose to
  ...
  <tr>
    ...
    <td>
      <p>
        Defines a human-readable, localized description for the role of an
        element that is read by screen readers.
      </p>
      <p>
        While <code>draggable</code> is a sensible default, we recommend you
        customize this value to something that is tailored to your use-case.
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      Each draggable item is provided a unique <code>aria-describedby</code> ID
